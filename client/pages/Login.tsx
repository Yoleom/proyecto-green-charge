      ...
      <div className="w-full max-w-md px-4">
        <div className="animate-slide-up">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-foreground/60">Inicia sesión en tu cuenta</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-border p-8 shadow-lg">
            <form className="space-y-5">
              ...
              <div className="flex justify-between items-center text-sm">
                <label className="flex items-center gap-2 cursor-pointer group">
                  ...
                  <span className="text-foreground/70 group-hover:text-foreground transition-colors">Recuérdame</span>
                </label>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white text-foreground/60">O continúa con</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              {/* Google Button */}
              <button className="w-full py-3 rounded-lg border border-border bg-background hover:bg-card/50 transition-all flex items-center justify-center gap-3 font-semibold text-secondary group">
